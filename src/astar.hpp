...
std::deque<Vector2Int> AStar(const Vector2Int &start, const Vector2Int &end, std::shared_ptr<Station> station, HeuristicFunction heuristic = Vector2IntDistanceSq);
