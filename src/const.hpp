...
inline float PAWN_OXYGEN_REFILL;
inline float PAWN_HEALTH_MAX;
inline float PAWN_EXTINGUISH_SPEED;
inline float PAWN_REPAIR_SPEED;
inline float PAWN_BUILD_SPEED;
inline float PAWN_DECONSTRUCT_EFFICIENCY;
