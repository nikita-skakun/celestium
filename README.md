...
| Pawn Pathfinding                  | :white_check_mark:   | Pawn pathfinding is done with A\* algorithm, which allows for pathing over complex station designs                                          |
| Air Diffusion                     | :white_check_mark:   | Oxygen spreads from high concentration to low, simulating real-life processes. Pawn and fire consume oxygen, while certain tiles produce it |
...
| Power Storage and Connections     | :white_check_mark:   | A rework is necessary to make power connections be part of the physical game world                                                          |
...
| Environmental Effects             | :construction:       | Environmental hazards and objects (like fire and foam), which can effect the pawn and the station                                           |
...
| Cross-Platform Builds             | :white_large_square: | Implement cross-platform for Linux (Done). Windows (Planned). MacOS (Unplanned)                                                             |
...
| Resources and Usage               | :white_large_square: | Require resources to build new tiles, and the building process should require pawn to work on it, instead of being instant                  |
